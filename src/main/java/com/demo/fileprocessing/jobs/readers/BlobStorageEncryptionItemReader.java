...
public class BlobStorageEncryptionItemReader implements ItemReader<String>, StepExecutionListener {

  private BlobClient blobClient;
  private BlobInputStream is;
  private BufferedReader br;

  public BlobStorageEncryptionItemReader(BlobClient blobClient) {
