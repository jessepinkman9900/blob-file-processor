...
public class BlobStorageEncryptionItemWriter implements ItemWriter<String>, StepExecutionListener {
  private AppendBlobClient blobClient;
  private BlobOutputStream os;

  public BlobStorageEncryptionItemWriter(AppendBlobClient blobClient) {
